...
public class MainCSVHelper extends csvHelper{ //contains read and write CSV
    ...
    public ArrayList<ShowTime> readFromShowTimeCSV() throws IOException{
        ...
        for(String[] item: showList){
            System.out.println(Arrays.toString(item));
            ShowTime mov = new Movies(item); //instantiates new objects that'll be kept in array
            results.add(mov);
        }
        return results;
    }
    public ArrayList<Cineplex> readFromCineplexDetailsCSV() throws IOException{
        ...
        for(String[] item: movieLists){
            System.out.println(Arrays.toString(item));
            Cineplex mov = new Movies(item); //instantiates new objects that'll be kept in array
            results.add(mov);
        }
        return results;
    }
    public ArrayList<Customer> readFromCustomerCSV() throws IOException{
        ...
        for(String[] item: movieLists){
            System.out.println(Arrays.toString(item));
            Customer mov = new Movies(item); //instantiates new objects that'll be kept in array
            results.add(mov);
        }
        return results;
    }
    public ArrayList<BookingOrder> readFromBookingOrderCSV() throws IOException{
        ...
        for(String[] item: movieLists){
            System.out.println(Arrays.toString(item));
            BookingOrder mov = new Movies(item); //instantiates new objects that'll be kept in array
            results.add(mov);
        }
        return results;
    }
    ...
    public void writeToMovieCSV(ArrayList<Movies> movies) throws IOException{
        String[] header = {"movieID", "movieTitle", "ratingList", "movieAgeRating", "showingStatus","movieAverageRating"};
    ...
    public void writeToShowTimeCSV(ArrayList<ShowTime> movies) throws IOException{
        String[] header = {"showBeings", "showEnds", "cinemaID"};
