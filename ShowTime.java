...
public class ShowTime implements Serialization{
   ...
   String[] csv = {convertToString(this.priceRate), convertToString(this.showBegins),
        convertToString(this.showEnds), convertToString(this.weekdayRate), convertToString(this.weekendRate)};
   return csv;
	}
