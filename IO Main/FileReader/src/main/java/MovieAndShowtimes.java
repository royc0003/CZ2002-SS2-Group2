...
public class MovieAndShowtimes {
	...
	public void createShowTime(String showBegins, Movie m, int cinemaID) {
		...
		Scanner sc = new Scanner(System.in);
		/*
		 * System.out.println("Insert the number of showTimes to be created"); int i =
		 * sc.nextInt(); for(int x = 0; x < i; x++){
		 */
...
//-------------------CSV RELATED FUNCTIONS------------------------------------------------------------------------------------------------------------
	/*
	 * public void initializeMovie() throws IOException { MainCSVHelper csvHelper =
	 * new MainCSVHelper(); try { ;
	 * System.out.println("**************************Initializing Objects....");
	 * ArrayList<Movie> temp = new ArrayList<Movie>(); temp =
	 * csvHelper.readFromMoviesCSV(); this.movie = temp.get(0); // retrieves the
	 * very first item for initilaization // test System.out.println("Test...");
	 * System.out.println(this.movie.getMovieTitle()); } catch(IOException e){
	 * e.getStackTrace(); System.out.println("Could not find the file"); } }
	 */

	/*
	 * public void saveMovieToCSV(Movie m){ MainCSVHelper csvHelper = new
	 * MainCSVHelper(); ArrayList<Movie> temp = new ArrayList<Movie>(); temp.add(m);
	 * try{
	 * System.out.println("***********************************Saving to CSV....");
	 * csvHelper.writeToMovieCSV(temp); } catch (IOException e) {
	 * e.printStackTrace(); } }
	 */
